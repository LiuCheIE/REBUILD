...
class OracleOperation:
	...
	def create_transform_parc_view(self, tablename):
		self.update_oracle("DROP TABLE {}".format(tablename), self.connection_cdtc)
		self.update_oracle("DROP TABLE TBL_TRANSFORM_PARC_NEXT_TEMP", self.connection_cdtc)
	...
	def add_to_test9(self):
		pass

	def replace_duplicate_ws(self):
		pass

	def recombine_split_polys(self):
		pass

	def skip_table(self):
		pass

	def update_md_non_active(self):
		pass

	def update_fad_gross_non_active(self):
		pass

	def test9e_from9e1(self):
		pass

	def replace_duplicate_ws_only(self):
		pass

	def insert_ws(self):
		pass

	def validate_subfeatures_oracle(self):
		pass

	def delete_efa_subfeatures(self):
		pass

	def replace_duplicate_subfeatures(self):
		pass

	def update_area_fenced_off(self):
		pass

	def delete_sf_from_whitespace(self):
		pass
	...
	def check_fme_run(self,numcode):
		try:
			...
			if fmecodes:
				print(fmecodes)
				if fmecodes:
					print("FME: {} successful to run!".format(numcode))
					self.flog("FME: {} successful to run!".format(numcode))
				else:
...
class OracleOperation:
	...
	def check_fme_run(self,numcode):
		try:
			...
			print(e)
			self.flog(e)
>>>>>>> f389e3a0af000ac511bbc19693dd675fe220b124
