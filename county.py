...
arrayC = ["O", "Q", "R", "B", "N", "L", "F", "I", "X", "U", "A", "Z", "K", "S", "T", "J", "P", "M", "E", "D", "H", "W", "Y", "V"]
County = "V"
CurrCounty = "V"
countyDelivered = ["O", "Q","R", "B", "N", "L", "F", "I", "X", "U","A", "Z", "K", "S", "T", "J","P", "M", "E", "D", "H", "W", "Y"]

array1 = {"V"}
ArrayIndex = 1


#DecodeCounty = "DECODE(EXTRACT_COUNTY, 'TIPPERARY', 'V', 'WEXFORD, 'Y', ''WATERFORD', 'W', 'KERRY', 'H',  'CORK', 'D', 'DONEGAL', 'E', 'LIMERICK', 'M', 'MAYO', 'P','KILKENNY', 'J', 'ROSCOMMON', 'T', 'OFFALY', 'S', 'LAOIS', 'K',  'WICKLOW', 'Z', 'CARLOW', " & _
 #       " 'A', 'SLIGO', 'U', 'WESTMEATH', 'X', 'KILDARE', 'I', 'DUBLIN', 'F', 'LEITRIM', 'L', 'LONGFORD', 'N', 'CAVAN', 'B','MONAGHAN','R', " & _
 #       "'MEATH','Q','LOUTH','O',   EXTRACT_COUNTY)"
